...
public class Battle {
    ...
    public static void main(String[] args) {
        ...
        warriorSpell.ability = "Whirlwind";
        warriorSpell.damage = 100;
        warriorSpell.ability2 = "Haymaker";
        warriorSpell.damage2 = 500;
        warriorSpell.ability3 = "Backstab";
        warriorSpell.damage3 = 200;

        wizard.role = "Wizard";
        wizard.name = "Blaze";
        wizard.health = 10000;
        wizardSpell.ability = "Lighting Bolt";
        wizardSpell.damage = 300;
        wizardSpell.ability2 = "Meteor Shower";
        wizardSpell.damage2 = 0;
        wizardSpell.ability3 = "Conjure Beast";
        wizardSpell.damage3 = 200;
        ...
        if (roleQuestion == 1) {
            ...
            System.out.println("\nAbilities:\n - " + warriorSpell.ability + ": Spin Your Axe Around Dealing " + warriorSpell.damage + " Damage 3 Times");
            System.out.println(" - " + warriorSpell.ability2 + ": Swing Your Axe with All Your Force Dealing " + warriorSpell.damage2 + " Damage with a 50% Chance to Miss");
            System.out.println(" - " + warriorSpell.ability3 + ": Sneak Up Behind Your Opponent and Stab Them in the Back Dealing " + warriorSpell.damage3 + " Damage with a 50% Chance to Deal Critical Damage");
        } else {
            System.out.println("\nYou have chosen " + wizard.name + " the " + wizard.role + "!");
            System.out.println("\nAbilities:\n - " + wizardSpell.ability + ": Direct a Blast of Energy Dealing " + wizardSpell.damage + " Damage");
            System.out.println(" - " + wizardSpell.ability2 + ": Rain Fire Down on Your Opponent Dealing 100 Damage 5 Times with a 50% Chance to Miss Each Shot");
            System.out.println(" - " + wizardSpell.ability3 + ": Summons a Wolf to Attack for you Dealing " + warriorSpell.damage3 + " Damage with a 50% Chance to Summon a Lion to Deal Critical Damage");
        }
    ...
    public static int castWarriorAbility(int AI, String warriorName, int warriorHealth, int wizardHealth, String warriorSpell, int warriorSpellDamage, String warriorSpell2, int warriorSpellDamage2, String warriorSpell3, int warriorSpellDamage3) {
        ...
        if (castAbility == 0) {
            ...
            wizardHealth = wizardHealth - (warriorSpellDamage * 3);
        ...
        if (castAbility == 1) {
            ...
            while (start < total) {
                ...
                if (hitTarget == 1) {
                    ...
                    wizardSpellDamage2 = wizardSpellDamage2 + 100;
            ...
            System.out.println("*" + wizardSpellDamage2 + " Damage");
