...
public class Battle {
    ...
    public static void main(String[] args) {
        ...
        warriorSpell.damage = 75;
        warriorSpell.ability2 = "Haymaker";
        warriorSpell.damage2 = 450;
        warriorSpell.ability3 = "Backstab";
        warriorSpell.damage3 = 175;

      
        wizardSpell.ability = "Lighting Bolt";
        wizardSpell.damage = 250;
        wizardSpell.ability2 = "Meteor Shower";
        wizardSpell.damage2 = 0;
        wizardSpell.ability3 = "Conjure Beast";
        wizardSpell.damage3 = 175;

         Character warrior = new Character(warriorSpell);
        Character wizard = new Character(wizardSpell);
        ...
        if (roleQuestion == 1) {
            ...
            System.out.println(" - " + wizardSpell.ability2 + ": Rain Fire Down on Your Opponent Dealing (75 - 125) Damage 5 Times with a 50% Chance to Miss Each Shot");
