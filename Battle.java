...
public class Battle {
    ...
    public static void main(String[] args) {
        ...
        assassin.abilityobject.ability = "Teleport";
        assassin.abilityobject.damage = 250;
        assassin.abilityobject.ability2 = "Tricks";
        assassin.abilityobject.damage2 = 0;
        assassin.abilityobject.ability3 = "Shurikens";
        assassin.abilityobject.damage3 = 175;
        
        alchemist.Character(alchemistSpell);
        alchemist.abilityobject.ability = "";
        alchemist.abilityobject.damage = 250;
        alchemist.abilityobject.ability2 = "";
        alchemist.abilityobject.damage2 = 0;
        alchemist.abilityobject.ability3 = "";
...
//                                System.out.println("- " + wizard.abilityobject.ability + ":  Dealing (250 - 350) Damage");
