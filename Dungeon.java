...
public class Dungeon {
    ...
    public static void main(String[] args) {
        ...
        boss3.abilityobject.damage2 = 100;
        boss3.abilityobject.ability3 = "Dash";
        boss3.abilityobject.damage3 = 175;
        
        boss4.Character(boss4Spell);
        boss4.abilityobject.ability = "Acid Spit";
        boss4.abilityobject.damage = 250;
        boss4.abilityobject.ability2 = "Devour";
        boss4.abilityobject.damage2 = 100;
        boss4.abilityobject.ability3 = "Dash";
        ...
        while (startGame == 1) {
            ...
            if (roleQuestion == 1) {
                ...
                if (rounds == 1) {
                    ...
                    System.out.println("- " + boss2.abilityobject.ability2 + ": Summon a Vengeful Spirit to Attack Your Opponent Dealing (450 - 600) Damage with a 50% Chance to Miss");
        ...
        while (startGame == 1) {
            ...
            if (roleQuestion == 1) {
                ...
                if (rounds == 1) {
                    ...
                    System.out.println("- " + boss3.abilityobject.ability2 + ": Take a Bite Out of Your Opponents Neck Causing Them to Bleed Out Dealing (100 - 150) Damage 4 Times with a 33% Chance to Miss Each");
