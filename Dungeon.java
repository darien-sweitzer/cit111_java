...
public class Dungeon {
    ...
    public static void main(String[] args) {
        ...
        if (roleQuestion == 10) {
            ...
            System.out.println("  3: Insane Damage -");
            System.out.println("  4:  -");
            System.out.println("  5: Infinite Health -");
            System.out.println("-------------------------\n");
            
            int cheatCode = userInput.nextInt();
            ...
            if (cheatCode == 3) {
                warrior.abilityobject.damage = 1000;
                warrior.abilityobject.damage2 = 1000;
                warrior.abilityobject.damage3 = 1000;
                wizard.abilityobject.damage = 1000;
                wizard.abilityobject.damage2 = 1000;
                wizard.abilityobject.damage3 = 1000;
                assassin.abilityobject.damage = 1000;
                assassin.abilityobject.damage2 = 1000;
                assassin.abilityobject.damage3 = 1000;
                alchemist.abilityobject.damage = 1000;
                alchemist.abilityobject.damage2 = 1000;
                alchemist.abilityobject.damage3 = 1000;
                necromancer.abilityobject.damage = 1000;
                necromancer.abilityobject.damage2 = 1000;
                necromancer.abilityobject.damage3 = 1000;
            } // insaneDamage
        ...
        while (true) {
            ...
            warrior.health = 1000;
            wizard.health = 1000;
            assassin.health = 1000;
            alchemist.health = 1000;
            necromancer.health = 1000;
