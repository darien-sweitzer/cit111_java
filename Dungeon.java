                ...
                while (startGame == 1) {
                    ...
                    if (roleQuestion == 1) {
                        ...
                        if (rounds == 1) {
                            ...
                            System.out.println("- " + boss5.abilityobject.ability2 + ": Drain the Life Force Out of Your Opponent Dealing (50 - 100) Damage 10 Times with a 33% Chance to Miss Each");
                    ...
                    while (true) {
                        ...
                        while (startGame == 1) {
                            ...
                            if (rounds == 1) {
                                ...
                                System.out.println("- " + warrior.abilityobject.ability3 + ": Sneak Up Behind Your Opponent and Stab Them in the Back Dealing (175 - 225) Damage with a 50% Chance to Deal Critical Damage");
