...
public class Dungeon {
    ...
    public static void main(String[] args) {
        ...
        boss4.abilityobject.damage = 250;
        ...
        while (startGame == 1) {
            ...
            if (roleQuestion == 1) {
                ...
                if (rounds == 1) {
                    ...
                    System.out.println("----------- Abilities -----------");
                    System.out.println("- " + boss4.abilityobject.ability + ": Convert Your Arms Into Gatlin Guns and Unload Dealing (75 - 125) Damage 3 Times");
        ...
        while (startGame == 1) {
            ...
            if (roleQuestion == 1) {
                ...
                if (rounds == 1) {
                    ...
                    System.out.println("----------- Abilities -----------");
                    System.out.println("- " + boss5.abilityobject.ability + ": Terrify Your Opponent by Following Them but Never Confronting Them Dealing (250 - 350) Damage");
                    ...
                    System.out.println("- " + boss5.abilityobject.ability3 + ": Rot Your Opponents Body Dealing (175 - 225) Damage with a 50% Chance to Corrupt Internal Organs & Deal Critical Damage");
    ...
    public static int castMechAbility(int AI, String mechName, int mechHealth, int warriorHealth, String mechSpell, int mechSpellDamage, String mechSpell2, int mechSpellDamage2, String mechSpell3, int mechSpellDamage3) {
        ...
        if (castAbility == 2) {
            ...
            int again = 50;
            int againDamage = randomizer.nextInt(max);
    ...
    public static int castDeathAbility(int AI, String deathName, int deathHealth, int warriorHealth, String deathSpell, int deathSpellDamage, String deathSpell2, int deathSpellDamage2, String deathSpell3, int deathSpellDamage3) {
        ...
        if (castAbility == 0) {
            ...
            while (loop < 3) {
                ...
                displayTotal = displayTotal + deathSpellDamage;
                deathSpellDamage = 75;
            }
        ...
        if (castAbility == 2) {
            ...
            int again = 50;
            int againDamage = randomizer.nextInt(max);
            deathSpellDamage3 = deathSpellDamage3 + againDamage;
            
            if(animal != 0) {
            
                if(hope != 3)
                System.out.println("\n*" + deathSpellDamage3 + " Damage");
                warriorHealth = warriorHealth - deathSpellDamage3;
