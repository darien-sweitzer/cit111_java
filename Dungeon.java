...
public class Dungeon {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nPick a class: \n\n1 - " + warrior.role + " | 2 - " + wizard.role + " | 3 - " + assassin.role + "\n");
        ...
        if (roleQuestion == 3) {
            ...
            System.out.println("----------- Abilities -----------");
            System.out.println("- " + assassin.abilityobject.ability + ": Choose 1 of 3 Mind Games To Play with & Terrorize Your Opponent Dealing (250 - 350) Damage");
            ...
            System.out.println("- " + assassin.abilityobject.ability3 + ": Rapid Fire Ninja Stars Towards Your Opponent Dealing (75 - 125) Damage Twice, Three Times in a Row with a 33% Chance to Miss Each Shot");
                ...
                if (bossRole == 1) {
                    ...
                    while (true) {
                        ...
                        while (startGame == 1) {
                            ...
                            if (rounds == 1) {
                                System.out.println("\n----- Hero 1: RAGNAR -----");
                                System.out.println("- Warrior : Armored : Dual-Wielded Longswords : Trained -");
                                System.out.println("- Inspirational : Extremely Strong : Righteous -");
                                System.out.println("----------- Abilities -----------");
                                System.out.println("- " + warrior.abilityobject.ability + ": Spin Your Axe Around Dealing (75 - 125) Damage 3 Times");
                                System.out.println("- " + warrior.abilityobject.ability2 + ": Swing Your Axe with All Your Force Dealing (450 - 600) Damage with a 50% Chance to Miss");
        ...
        if (castAbility == 2) {
            ...
            while (start < total) {
                ...
                if (hitTarget == 2) {
                    ...
                    assassinSpellDamage2 = 75;
                    int max = 50;
                    int moreDamage = randomizer.nextInt(max);
                    assassinSpellDamage2 = assassinSpellDamage2 + moreDamage;
                    System.out.println("- Hit!\n*" + assassinSpellDamage2);
                    System.out.println("*" + assassinSpellDamage2);
                    warriorHealth = warriorHealth - (assassinSpellDamage2 * 2);
                    displayTotal = displayTotal + (assassinSpellDamage2 * 2);
