...
public class Hitmen {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nMercenary:\n- Unprofessional, non-trained soldiers. Will do anything in exchange for money though, specializing in guerilla warfare and dirty tactics.\n- Cause a high amount of chaos due to public killings and uncarefulness but there cheap and versatile.");
        System.out.println("\nAssassin:\n- Highly trained and certified killers. Expensive but necessary for high-value targets.\n- Cause a small amount of chaos due to clean and silent kills. Can also kill 20x the amount as a mercenary but are extremely expensive.");
        System.out.println("\nMilitia:\n- Semi-Professional group of soldiers formed into a small army. Only slightly trained but has power in numbers.\n- Cause the largest amount of chaos due to starting wars and ransacking entire cities at one time but can also kill the most men.");
